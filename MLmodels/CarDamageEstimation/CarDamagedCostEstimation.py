...
company_name = "Honda"  # Example car company name (replace accordingly)
...
print("Detected damaged parts with their estimated costs:")
for part, cost in damaged_parts_costs.items():
    print(f"{part}: {cost}")
